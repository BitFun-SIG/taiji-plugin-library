...
pub fn builtin_agent_definition_specs() -> Vec<BuiltinAgentDefinitionSpec> {
    ...
    vec![
        ...
        builtin_agent_spec("agentic", Mode, "primary", SubagentVisibilityPolicy::default()),
        builtin_agent_spec("Cowork", Mode, "primary", SubagentVisibilityPolicy::default()),
        builtin_agent_spec(
            "Creative",
            Mode,
            "primary",
        ...
        builtin_agent_spec("group", Mode, "primary", SubagentVisibilityPolicy::default()),
        builtin_agent_spec(
            "DeepResearch",
            Mode,
            "primary",
        ...
        builtin_agent_spec("Legion", Mode, "primary", SubagentVisibilityPolicy::default()),
        builtin_agent_spec(
            "SwarmPlanner",
            SubAgent,
            "primary",
