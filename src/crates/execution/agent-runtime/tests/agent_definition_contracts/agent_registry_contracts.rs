...
fn mode_presentation_and_shared_context_policy_match_existing_mode_contract() {
    ...
    assert_eq!(mode_presentation_rank("Ultra"), 4);
    assert_eq!(mode_presentation_rank("Creative"), 5);
    assert_eq!(mode_presentation_rank("Legion"), 7);
...
fn builtin_agent_definition_catalog_preserves_order_categories_models_and_visibility() {
    ...
    assert_eq!(default_model_id_for_builtin_agent("minimal"), "primary");
